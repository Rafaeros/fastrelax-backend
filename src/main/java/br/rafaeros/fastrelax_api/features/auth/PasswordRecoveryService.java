 ...
 *
 * <p>
 * <b>A resposta do pedido nunca varia.</b> E-mail inexistente, conta
 * desativada,
...
public class PasswordRecoveryService {
         ...
         */
        public static final String GENERIC_REQUEST_MESSAGE = "Se houver uma conta com este e-mail, o link de redefinição chegará em instantes.";
        ...
        public void requestForCollaborator(String companySlug, String email) {
                ...
                companyRepository.findBySlug(slug)
                                ...
                                .flatMap(company -> accounts.of(RefreshToken.SubjectType.COLLABORATOR)
                                                .flatMap(account -> account.findByEmail(normalize(email),
                                                                company.getId())))
                                .ifPresent(this::sendReset);
        }
